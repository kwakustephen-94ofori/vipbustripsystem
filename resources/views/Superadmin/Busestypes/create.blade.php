                            ...
                            <ul class="card-actions">
                                <li>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form class="form-horizontal" action="{{ route('post-create-buses-types')}}" method="post">

                                            {{ csrf_field() }}

                                            <div class="form-group" style="padding: 20px;">
                                                <label class="col-xs-12" for="bustypename">Bus Type Name</label>
                                                <div class="col-xs-12">
                                                    <input class="form-control" type="text" id="bustypename" name="bustypename" placeholder="Eg. Toyota" style="padding: 10px;" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-b-0">
                                                <div class="col-xs-12">
                                                    <button class="btn btn-app" type="submit">Add Bus Type</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
