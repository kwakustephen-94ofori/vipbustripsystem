                        ...
                        <div class="card-header bg-green bg-inverse">
                            <h4>ADD NEW DRIVER</h4>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form class="form-horizontal" action="{{ route('post-create-drivers')}}" method="post">
                                           ...
                                           <div class="form-group" style="padding: 5px;">
                                            ...
                                            <div class="form-group" style="padding: 5px;">
                                                <label class="col-xs-12" for="driver_contact">Driver Contact Number</label>
                                                <div class="col-xs-12">
                                            ...
                                            <div class="form-group" style="padding: 5px;">
                                                <label class="col-xs-12" for="emergency_contact">Driver Emergency Contact Number</label>
                                                <div class="col-xs-12">
                                              ...
                                              <div class="form-group m-b-0">
                                                <div class="col-xs-12">
                                                    <button class="btn btn-app" type="submit">Add Driver</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
